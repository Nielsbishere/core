...
namespace oi {
	...
	namespace wc {
		...
		#ifdef __WINDOWS__
		DEnum(Key, u32, Undefined = 0, Zero = 48, One = 49, Two = 50, Three = 51, Four = 52, Five = 53, Six = 54, Seven = 55, Eight = 56, Nine = 57, A = 65, B = 66, C = 67, D = 68, E = 69,
			...
			Home = VK_HOME, End = VK_END, Insert = VK_INSERT, Delete = VK_DELETE, Scroll_lock = VK_SCROLL, Num_lock = VK_NUMLOCK, Caps_lock = VK_CAPITAL, Right_alt = VK_RMENU, Right_shift = VK_RSHIFT,
			Right_ctrl = VK_RCONTROL, Left_alt = VK_LMENU, Left_shift = VK_LSHIFT, Left_ctrl = VK_LCONTROL, Tab = VK_TAB, Enter = VK_RETURN, Backspace = VK_BACK, Esc = VK_ESCAPE
		);
		#endif
