...
makeAndroid() {
	...
	cmake "../../../" -G "Unix Makefiles" -DCMAKE_TOOLCHAIN_FILE=${ANDROID_NDK}/build/cmake/android.toolchain.cmake -DANDROID_NATIVE_API_LEVEL=android-$2 -DCMAKE_MAKE_PROGRAM=${ANDROID_NDK}/prebuilt/$1/bin/make.exe -DCMAKE_BUILD_TYPE=Release -DANDROID_ABI="$3" -DAndroid=ON -DANDROID_APK_RUN=ON -DANDROID_STL=c++_shared
